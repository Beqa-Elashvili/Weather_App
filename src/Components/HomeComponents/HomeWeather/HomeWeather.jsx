...
export function HomeWeather() {
  ...
  return (
    <div className="relative w-full p-6 md:p-6 lg:p-6 xl:p-6 bg-slate-100 bg-opacity-60 text-white flex flex-col z-10 gap-2 border-solid border border-blue-300 rounded-xl  lg:max-w-[400px]">
