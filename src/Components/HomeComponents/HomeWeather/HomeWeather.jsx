...
export function HomeWeather() {
  ...
  return (
    <div className="relative bg-slate-100 bg-opacity-60 text-white flex flex-col z-10 gap-2 border-solid border border-blue-300 rounded-xl max-w-[400px]">
        ...
        <div>
          <div className="flex flex-col items-center">
            ...
            <div className="grid grid-cols-2 gap-2 ">
              <div className="bg-slate-500 p-4 rounded-xl w-36">
